...
export function GithubLogo({ fill = strokeColorDark, size = defaultLogoSize }) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function Xlogo({ fill = strokeColorDark, size = defaultLogoSize }) {
  return (
    <svg
      fill={fill}
      role="img"
...
export function YTlgo({ fill = strokeColorDark, size = defaultLogoSize }) {
  return (
    <svg
      fill={fill}
      role="img"
...
export function UpworkLogo({ fill = strokeColorDark, size = defaultLogoSize }) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function TGlogo({ fill = strokeColorDark, size = defaultLogoSize }) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
